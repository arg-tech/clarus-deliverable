...
def analyse(text: str, language: str = "en", morphodita: MorphoDiTaProtocol | None = None, omorfi: OmorfiProtocol | None = None, stanza: StanzaProtocol | None = None) -> list[BiasIndicatorResult]:
    language_map = {
        "en": "oversimplified_group_labels_en.json",
        "fi": "oversimplified_group_labels_fi_lemmas.json",
        "fi_fallback": "oversimplified_group_labels_fi.json",
        "pt": "oversimplified_group_labels_pt_patterns.json",
        "cs": "oversimplified_group_labels_cs_lemmas.json",
        "cs_fallback": "oversimplified_group_labels_cs.json",
        "el": "oversimplified_group_labels_el_lemmas.json",
        "el_patterns": "oversimplified_group_labels_el_patterns.json",
        "el_fallback": "oversimplified_group_labels_el.json",
    }
    ...
    return [
        BiasIndicatorResult(
            bias_indicator_key="oversimplifiedGroupLabels",
