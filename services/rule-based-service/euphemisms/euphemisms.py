...
def analyse(text: str, language: str = "en", morphodita: MorphoDiTaProtocol | None = None, omorfi: OmorfiProtocol | None = None, stanza: StanzaProtocol | None = None) -> list[BiasIndicatorResult]:
    language_map = {
        "en": "euphemisms_en.json",
        "fi": "euphemisms_fi_lemmas.json",
        "fi_fallback": "euphemisms_fi.json",
        "pt": "euphemisms_pt_patterns.json",
        "cs": "euphemisms_cs_lemmas.json",
        "cs_fallback": "euphemisms_cs.json",
        "el": "euphemisms_el_lemmas.json",
        "el_patterns": "euphemisms_el_patterns.json",
        "el_fallback": "euphemisms_el.json",
    }
