...
def analyse(text: str, language: str = "en", morphodita: MorphoDiTaProtocol | None = None, omorfi: OmorfiProtocol | None = None, stanza: StanzaProtocol | None = None) -> list[BiasIndicatorResult]:
    language_map = {
        "en": "mitigators_en.json",
        "fi": "mitigators_fi_lemmas.json",
        "fi_fallback": "mitigators_fi.json",
        "pt": "mitigators_pt_patterns.json",
        "cs": "mitigators_cs_lemmas.json",
        "cs_fallback": "mitigators_cs.json",
        "el": "mitigators_el_lemmas.json",
        "el_patterns": "mitigators_el_patterns.json",
        "el_fallback": "mitigators_el.json",
    }
