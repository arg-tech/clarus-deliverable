...
def analyse(text: str, language: str = "en", morphodita: MorphoDiTaProtocol | None = None, omorfi: OmorfiProtocol | None = None, stanza: StanzaProtocol | None = None) -> list[BiasIndicatorResult]:
    language_map = {
        "en": "event_labeling_en.json",
        "fi": "event_labeling_fi_lemmas.json",
        "pt": "event_labeling_pt_patterns.json",
        "cs": "event_labeling_cs_lemmas.json",
        "cs_fallback": "event_labeling_cs.json",
        "fi_fallback": "event_labeling_fi.json",
        "el": "event_labeling_el_lemmas.json",
        "el_patterns": "event_labeling_el_patterns.json",
        "el_fallback": "event_labeling_el.json",
    }
    ...
    return [
        BiasIndicatorResult(
            bias_indicator_key="eventLabeling",
