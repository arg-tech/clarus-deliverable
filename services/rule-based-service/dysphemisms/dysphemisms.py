...
def analyse(text: str, language: str = "en", morphodita: MorphoDiTaProtocol | None = None, omorfi: OmorfiProtocol | None = None, stanza: StanzaProtocol | None = None) -> list[BiasIndicatorResult]:
    language_map = {
        "en": "dysphemisms_en.json",
        "fi": "dysphemisms_fi_lemmas.json",
        "fi_fallback": "dysphemisms_fi.json",
        "cs": "dysphemisms_cs_lemmas.json",
        "cs_fallback": "dysphemisms_cs.json",
        "pt": "dysphemisms_pt_patterns.json",
        "el": "dysphemisms_el_lemmas.json",
        "el_patterns": "dysphemisms_el_patterns.json",
        "el_fallback": "dysphemisms_el.json",
    }
    ...
    return [
        BiasIndicatorResult(
            bias_indicator_key="dysphemisms",
